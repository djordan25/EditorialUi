# EditorialUI · Visual verification harness — Bundle 7 (Navigation)
...
- `EdTabs` → `design_system_v2/components/tabs.html`
- `EdBreadcrumb` → `design_system_v2/components/breadcrumb.html`
- `EdMenu` → `design_system_v2/components/menu.html`
- `EdContextMenu` → `design_system_v2/components/context-menu.html`
...
The oracle is this bundle's spec HTML (tabs.html / breadcrumb.html / menu.html / context-menu.html). They resolve automatically in
