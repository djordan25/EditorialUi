// EditorialUI · public barrel — COMPLETE (Bundles 1–9)
//
// Foundations + Forms + Selection + Display + Feedback + Containers + Navigation
// + Data + Late composites. 37 primitives across 7 spec groups.
...
/* ---- Bundle 9 — Late composites ---- */
export { EdTagContainer } from './EdTagContainer';
export type { EdTagContainerProps } from './EdTagContainer';

export { EdTagSelect } from './EdTagSelect';
export type { EdTagSelectProps, EdTagOption } from './EdTagSelect';
...
export type { EdDateRangePickerProps, EdDateRange, EdDateRangePreset, EdISODate } from './EdDateRangePicker';
