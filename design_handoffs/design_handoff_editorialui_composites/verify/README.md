# EditorialUI · Visual verification harness — Bundle 9 (Late composites)
...
- `EdTagContainer` → `design_system_v2/components/tag-container.html`
- `EdTagSelect` → `design_system_v2/components/tag-select.html`
- `EdFilterChipRow` → `design_system_v2/components/filter-chip-row.html`
- `EdDateRangePicker` → `design_system_v2/components/date-range-picker.html`
...
The oracle is this bundle's spec HTML (tag-container.html / tag-select.html / filter-chip-row.html / date-range-picker.html). They resolve automatically in
