# EditorialUI · Visual verification harness — Bundle 6 (Containers)
...
- `EdCard` → `design_system_v2/components/card.html`
- `EdModal` → `design_system_v2/components/modal.html`
- `EdDrawer` → `design_system_v2/components/side-panel.html`
- `EdDisclosure` → `design_system_v2/components/disclosure.html`
- `EdAccordion` → `design_system_v2/components/accordion.html`
...
The oracle is this bundle's spec HTML (card.html / modal.html / side-panel.html / disclosure.html / accordion.html). They resolve automatically in
