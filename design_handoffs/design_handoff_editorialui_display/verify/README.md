# EditorialUI · Visual verification harness — Bundle 4 (Display)
...
- `EdTag` → `design_system_v2/components/tag.html`
- `EdStatusBadge` → `design_system_v2/components/status-badge.html`
- `EdChip` → `design_system_v2/components/chip.html`
- `EdDivider` → `design_system_v2/components/divider.html`
- `EdProgressMeter` → `design_system_v2/components/progress-meter.html`
- `EdCircularProgress` → `design_system_v2/components/circular-progress.html`
...
The oracle is this bundle's spec HTML (tag.html / status-badge.html / chip.html / divider.html / progress-meter.html / circular-progress.html). They resolve automatically in
