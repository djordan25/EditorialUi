...
// Bundle 1 + EdTextField hand-wired; bundles 2-9 reconciled via the workflow
// (content-matched labels + contract-element anchors). Regenerated by gen-map.mjs.
// Portal-only components with no mappable closed-trigger spec cell (EdDialog,
// EdModal, EdContextMenu) are intentionally absent.
