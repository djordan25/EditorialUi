# EditorialUI · Visual verification harness — Bundle 3 (Selection)
...
- `EdSelect` → `design_system_v2/components/select.html`
- `EdComboBox` → `design_system_v2/components/combobox.html`
- `EdAutocomplete` → `design_system_v2/components/autocomplete.html`
...
The oracle is this bundle's spec HTML (select.html / combobox.html / autocomplete.html). They resolve automatically in
